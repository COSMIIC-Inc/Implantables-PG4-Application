...
/**
 * @file   lss.c
 * @author Jorge Berzosa, modified by JDC
 * @brief <BRIEF> lss.c
 */
...
/** 
 * @ingroup lss
 * @brief transmit a LSS message 
 * @param *d Pointer on a CAN object data structure
 * @param command LSS command specifier
 * @param dat1 pointer to optional data (depend on command)
 * @param dat2 pointer to optional data (depend on command)
 * @return 
 */
...
/** 
 * @ingroup lss
 * @brief This function is called when the node is receiving a Master LSS message (cob-id = 0x7E5).
